...
mkSeqConcat = liftAstN "Z3.Base.mkSeqConcat: empty list of expressions" z3_mk_seq_concat
...
mkReUnion :: Context -> [AST] -> IO AST
mkReUnion = liftAstN "Z3.Base.mkReUnion: empty list of expressions" z3_mk_re_union
